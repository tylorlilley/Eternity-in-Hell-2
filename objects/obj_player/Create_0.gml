...
with create_item_in_hand(directions.left, obj_torch) { make_item_special(); light_torch(noone, true); };
with create_item_in_hand(directions.right, obj_sword) { make_item_special(); }
