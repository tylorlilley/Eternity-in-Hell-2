...
if (transition != directions.none || has_won || has_timed_out || is_looking_at_map) {
    ...
    if (is_looking_at_map && !has_won && !has_lost && transition == directions.none) {
		...
		var clock_sprite = get_sprite_to_use(spr_clock)
		draw_sprite(clock_sprite, 0, room_width-12, room_height-12);
		draw_sprite(get_sprite_to_use(spr_clock_sand), (clock_sprite == spr_clock) ? 0 : 2, room_width-12, room_height-12);
    }
