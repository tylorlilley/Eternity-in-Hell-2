...
function create_room_lists() {
	...
	ds_list_add(global.rooms_with_one_exit, rm_one_exit_1, rm_one_exit_2, rm_one_exit_3, rm_one_exit_4, rm_one_exit_5, rm_one_exit_6, rm_one_exit_7, rm_one_exit_8, rm_one_exit_9, rm_one_exit_10, rm_one_exit_11, rm_one_exit_12, rm_one_exit_13, rm_one_exit_14, rm_one_exit_15);
...
function duplicate_room_from_list(list) {
	...
	var chosen_room = rm_four_exits_16; //ds_list_find_value(list, 0);
