...
if (is_blink_frame() && (place_meeting(x, y, obj_hands) || place_meeting(x, y, player))) {
	for (var quadrant = 0; quadrant < 4; quadrant++;) {
		...
		if (!place_meeting(x+x_offset, y+y_offset, obj_hands) && !place_meeting(x+x_offset, y+y_offset, player)) {
